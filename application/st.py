...
days = PlotOptions.load_data()

col1, col2,col3 = st.columns(3)
with col1:
    st.pyplot(PlotOptions.plot_energy_demand_by_category_over_time(days[0]))
    st.pyplot(PlotOptions.plot_energy_demand_over_time(days[0]))
with col2:
    st.pyplot(PlotOptions.plot_demand_by_hour_and_weekday(days[0]))
with col3:
    st.pyplot(PlotOptions.plot_energy_consumption_by_category(days[0]))
